        ...
        <div className="flex flex-wrap items-center sm:-mx-3">
          <div className="w-full md:w-1/2 md:px-3">
            <div className="space-y-6 sm:max-w-md lg:max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-[#c0caf5] sm:text-5xl">
                <span className="block xl:inline">Explore Countries with </span>
                <span className="block text-[#3a55cc] xl:inline">
                  Real-Time Data
                </span>
              </h1>
              <p className="text-base text-[#c0caf5] sm:max-w-md lg:text-xl">
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-4">
                <Link
                  to="/countries"
                  className="flex items-center justify-center px-6 py-3 text-lg text-white bg-[#314dc7] rounded-md hover:bg-[#1c35a3]"
                >
                  Explore Now
                  <svg
                ...
                <Link
                  to="/about"
                  className="flex items-center px-6 py-3 text-white bg-gray-400/50 rounded-md hover:bg-gray-400/60 hover:text-white"
                >
                  Learn More
                </Link>
              </div>
